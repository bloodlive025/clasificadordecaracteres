...
<script>
  ...
  function InitThis() {
      ...
      document.getElementById('mensaje').innerHTML  = 'Dibuja la vocal rusa: ' + aleatorio;
...
if __name__ == "__main__":
    ...
    vocales_rusas = ['а', 'э', 'ы', 'и', 'о', 'у']
    for vocal in vocales_rusas:
        if not os.path.exists(str(vocal)):
            os.mkdir(str(vocal))
    app.run()